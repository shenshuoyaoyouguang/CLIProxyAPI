...
func TestThinkingE2EMatrix_Suffix(t *testing.T) {
	...
	cases := []thinkingTestCase{
		...
		// Case 11: Claude source no suffix → injected default → minimal
		{
			name:        "11",
			from:        "claude",
			to:          "openai",
		...
		// Case 18: No suffix → injected default → auto (DynamicAllowed)
		{
			name:        "18",
			from:        "openai",
			to:          "gemini",
		...
		// Case 23: Claude source no suffix → injected default → auto (DynamicAllowed)
		{
			name:        "23",
			from:        "claude",
			to:          "gemini",
		...
		// Case 28: OpenAI source no suffix → injected default → low (first level)
		{
			name:        "28",
			from:        "openai",
			to:          "gemini",
		...
		// Case 33: Claude source no suffix → injected default → low (first level)
		{
			name:        "33",
			from:        "claude",
			to:          "gemini",
		...
		// Case 38: OpenAI source no suffix → injected default → Budget=1024 (Min)
		{
			name:        "38",
			from:        "openai",
			to:          "claude",
		...
		// Case 43: Gemini source no suffix → injected default → Budget=1024 (Min)
		{
			name:        "43",
			from:        "gemini",
			to:          "claude",
		...
		// Case 48: Gemini to Antigravity no suffix → injected default → auto (DynamicAllowed)
		{
			name:        "48",
			from:        "gemini",
			to:          "antigravity",
		...
		// Case 53: Claude to Antigravity no suffix → injected default → auto (DynamicAllowed)
		{
			name:        "53",
			from:        "claude",
			to:          "antigravity",
...
func TestThinkingE2EMatrix_Body(t *testing.T) {
	...
	cases := []thinkingTestCase{
		...
		// Case 11: Claude no param → injected default → minimal
		{
			name:        "11",
			from:        "claude",
			to:          "openai",
		...
		// Case 18: No param → injected default → auto (DynamicAllowed)
		{
			name:        "18",
			from:        "openai",
			to:          "gemini",
		...
		// Case 23: Claude no param → injected default → auto (DynamicAllowed)
		{
			name:        "23",
			from:        "claude",
			to:          "gemini",
		...
		// Case 28: No param → injected default → low (first level)
		{
			name:        "28",
			from:        "openai",
			to:          "gemini",
		...
		// Case 31C: reasoning_effort=none with zero allowed to Antigravity → preserve thinkingConfig
		{
			name:            "31C",
			from:            "openai",
			to:              "antigravity",
			model:           "gemini-zero-mixed-model",
			inputJSON:       `{"model":"gemini-zero-mixed-model","messages":[{"role":"user","content":"hi"}],"reasoning_effort":"none"}`,
			expectField:     "request.generationConfig.thinkingConfig.thinkingLevel",
			expectValue:     "none",
			includeThoughts: "false",
			expectErr:       false,
		},
		// Case 31D: reasoning.effort=none with zero allowed
		{
			name:            "31D",
			from:            "openai-response",
			to:              "gemini",
		...
		// Case 31F: reasoning.effort=none with zero allowed to Antigravity → preserve thinkingConfig
		{
			name:            "31F",
			from:            "openai-response",
			to:              "antigravity",
		...
		// Case 33: Claude no param → injected default → low (first level)
		{
			name:        "33",
			from:        "claude",
			to:          "gemini",
		...
		// Case 38: No param → injected default → Budget=1024 (Min)
		{
			name:        "38",
			from:        "openai",
			to:          "claude",
		...
		// Case 43: Gemini no param → injected default → Budget=1024 (Min)
		{
			name:        "43",
			from:        "gemini",
			to:          "claude",
		...
		// Case 48: Gemini no param → injected default → auto (DynamicAllowed)
		{
			name:        "48",
			from:        "gemini",
			to:          "antigravity",
		...
		// Case 53: Claude no param → injected default → auto (DynamicAllowed)
		{
			name:        "53",
			from:        "claude",
			to:          "antigravity",
