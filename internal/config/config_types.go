...
// ZAIKey uses the Codex API key structure for native Z.ai execution.
type ZAIKey = CodexKey

// ZAIModel uses the Codex model mapping structure for Z.ai models.
type ZAIModel = CodexModel
