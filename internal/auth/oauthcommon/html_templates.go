...
// Provider-branded success-page templates moved verbatim from
// internal/auth/claude and internal/auth/codex. They are unexported; use the
// ClaudeServerOptions/CodexServerOptions presets to wire them into a Server.

const (
	claudeLoginSuccessHTML = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
	...
	codexLoginSuccessHTML = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
func ClaudeServerOptions() Options {
	return Options{
		...
		SuccessTemplate:     claudeLoginSuccessHTML,
		SetupNoticeTemplate: claudeSetupNoticeHTML,
	}
}
...
func CodexServerOptions() Options {
	return Options{
		...
		SuccessTemplate:     codexLoginSuccessHTML,
		SetupNoticeTemplate: codexSetupNoticeHTML,
	}
}
