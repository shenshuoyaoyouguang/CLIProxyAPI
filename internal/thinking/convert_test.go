...
func TestConvertLevelToBudget(t *testing.T) {
	tests := []struct {
		...
		{level: "minimal", wantBudget: -1, wantOK: true},
		{level: "low", wantBudget: -1, wantOK: true},
		{level: "medium", wantBudget: -1, wantOK: true},
		{level: "high", wantBudget: 24576, wantOK: true},
		{level: "xhigh", wantBudget: 32768, wantOK: true},
		{level: "max", wantBudget: 65536, wantOK: true},
		{level: "HIGH", wantBudget: 24576, wantOK: true},
		{level: "Medium", wantBudget: -1, wantOK: true},
...
func TestConvertBudgetToLevel(t *testing.T) {
	tests := []struct {
		...
		{budget: 1024, wantLevel: "minimal", wantOK: true},
		{budget: 1025, wantLevel: "low", wantOK: true},
		{budget: 2048, wantLevel: "low", wantOK: true},
		{budget: 3000, wantLevel: "medium", wantOK: true},
		...
		{budget: 24577, wantLevel: "high", wantOK: true},
		{budget: 32768, wantLevel: "high", wantOK: true},
		{budget: 32769, wantLevel: "xhigh", wantOK: true},
