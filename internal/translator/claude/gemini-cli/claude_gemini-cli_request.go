...
import (
	geminipkg "github.com/router-for-me/CLIProxyAPI/v6/internal/translator/claude/gemini"
...
func ConvertGeminiCLIRequestToClaude(modelName string, inputRawJSON []byte, stream bool) []byte {
	...
	return geminipkg.ConvertGeminiRequestToClaude(modelName, rawJSON, stream)
}
