...
// ClaudeUsageTokens accumulates Claude-style usage token counts merged from
// streamed or non-streamed usage payloads.
...
// Merge folds a Claude usage payload into the accumulator, keeping existing
